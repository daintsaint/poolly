      ...
      <form onSubmit={handleSubmit}>
        <div style={{ marginBottom: 16 }}>
          ...
          <input
            ...
            onBlur={(e) => { e.currentTarget.style.borderColor = "var(--b-rule)"; }}
          />
        </div>
        ...
        <button
          ...
          style={{
            ...
            color: loading || !password ? "var(--b-paper-40)" : "var(--b-ink)",
            border: "none",
            padding: "11px 16px",
            fontFamily: "var(--font-geist-mono), monospace",
            fontSize: 11,
    ...
    >
      <div style={{ width: "100%", maxWidth: 380, padding: "0 24px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          ...
          <span className="b-eyebrow" style={{ color: "var(--b-gold)", letterSpacing: "0.12em" }}>
            Admin
          </span>
        </div>

        {/* Wrap in Suspense — required by Next.js 16 for useSearchParams() */}
        <Suspense
          fallback={
            <div
              style={{
